    ...
    <section ref={containerRef} className="w-full bg-black text-white py-24 md:py-40 px-6 md:px-12">
      <div className="max-w-[1370px] mx-auto">
        ...
        <div className="flex flex-col gap-4 mb-20 value-fade">
             <span className="text-sm font-mono uppercase tracking-widest text-[#f66e40]">Our Core Values</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-16">
           {values.map((v, i) => (
             <div key={i} className="value-fade group flex flex-col items-start border-t border-gray-800 pt-8 hover:border-brand-orange/50 transition-colors duration-500">
                <span className="font-mono text-brand-orange text-sm mb-6">0{i+1}</span>
                <h3 className="text-3xl font-display font-bold mb-4 group-hover:text-brand-orange transition-colors duration-300">{v.title}</h3>
