...
export default function AboutCTA({ initialData }: { initialData?: any }) {
    const containerRef = useRef<HTMLDivElement>(null);

    const title = initialData?.ctaTitle || "";
    const description = initialData?.ctaDescription || "";
    const buttonText = initialData?.ctaButton || "";
