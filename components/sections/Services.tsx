...
import { Plus, Minus, Target, Palette, Code, Layers, HelpCircle } from "lucide-react";
...
export default function Services({ isActive, initialData }: { isActive?: boolean; initialData?: any }) {
      ...
      <div className="max-w-[1400px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start relative z-10">
        ...
        <div className="flex flex-col justify-start lg:sticky lg:top-32 h-fit">
          <div className="service-anim flex items-center gap-3 mb-4">
            ...
            <span className="text-[#00b4d9] font-mono text-xs tracking-widest uppercase font-bold">{servicesData.expertise}</span>
          </div>

          <h2 className="service-anim text-4xl md:text-5xl font-display font-semibold leading-[1.1] tracking-tight mb-6 text-white">
            {servicesData.title} <br /> <span className="italic text-white/60 font-medium">{servicesData.titleHighlight}</span>
          </h2>
          ...
          <div className="service-anim hidden lg:block">
            <div className="flex gap-12 border-t border-white/10 pt-6">
              <div className="flex flex-col gap-1">
                <span className="text-3xl font-bold font-display text-white">{servicesData.yearsExp}</span>
                <span className="text-xs font-mono uppercase text-gray-500 tracking-wider">Years Exp</span>
              </div>
              <div className="flex flex-col gap-1">
                <span className="text-3xl font-bold font-display text-white">{servicesData.awardsWon}</span>
