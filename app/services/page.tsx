      ...
      <div className="container mx-auto px-6 pb-24 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-20">
          ...
          <p className="animate-header text-gray-400 text-xl md:text-2xl max-w-2xl leading-relaxed">
            Comprehensive digital solutions tailored to your brands unique needs.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 max-w-7xl mx-auto">
          {services.map((service) => (
            ...
            >
              ...
              >
                {/* Card Container */}
                <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl p-8 h-full flex flex-col transition-all duration-300 group-hover:border-purple-500/50 group-hover:shadow-2xl group-hover:shadow-purple-500/20">
                  {/* Icon */}
                  ...
                  {/* Title */}
                  <h3 className="text-2xl md:text-3xl font-display font-semibold mb-3 group-hover:text-purple-400 transition-colors">
                    {service.title}
                  </h3>
